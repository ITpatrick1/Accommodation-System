        ...
        <div class="row">
          <div class="col">
            ...
            <div class="contact_text text-center">
              <p>We provide excellent service to make sure you have everything you need. Our hotel is designed for your comfort, with easy check-in and check-out. You’ll enjoy a pleasant stay with us, thanks to our friendly staff and cozy rooms.</p>
            </div>
        ...
        <div class="d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="contact_info_list">
            <ul class="text-center">
              <li>Rwanda, Rulindo, Texas</li>
              <li>itdepartmentyaer3@gmail.com</li>
              <li>791-420-831</li>
            </ul>
          </div>
        </div>
