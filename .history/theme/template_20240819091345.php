...
<div class="super_container">
  ...
  <div class="home">
    ...
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      ...
      <div class="home_text text-center">We focus on making your stay comfortable, with nice rooms and everything you need. Booking is easy, and we'll handle the details so you can relax and enjoy your time with us.</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This system is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by Year 3 IT Guys</a>
</div>
        </div>
      </div>
    </div>
