...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $DBIRTH = $conn->real_escape_string($_POST['DBIRTH']);
    $G_PHONE = $conn->real_escape_string($_POST['G_PHONE']);
    $G_NATIONALITY = $conn->real_escape_string($_POST['G_NATIONALITY']);
    $G_COMPANY = $conn->real_escape_string($_POST['G_COMPANY']);
    $G_CADDRESS = $conn->real_escape_string($_POST['G_CADDRESS']);
    ...
    $sql = "INSERT INTO tblguest (G_FNAME, G_LNAME, G_CITY, G_ADDRESS, DBIRTH, G_PHONE, G_NATIONALITY, G_COMPANY, G_CADDRESS, G_EMAIL, G_UNAME, G_PASS) 
            VALUES ('$G_FNAME', '$G_LNAME', '$G_CITY', '$G_ADDRESS', '$DBIRTH', '$G_PHONE', '$G_NATIONALITY', '$G_COMPANY', '$G_CADDRESS', '$G_EMAIL', '$G_UNAME', '$G_PASS')";
