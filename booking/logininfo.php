...
function listofbooking() {
    global $mydb; // Ensure mydb is accessible within the function
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                for ($i = 0; $i < $count_cart; $i++) {
                    $roomId = $_SESSION['dragonhouse_cart'][$i]['dragonhouseroomid'];
                    $query = "SELECT * FROM `tblroom` r, `tblaccomodation` a WHERE r.`ACCOMID` = a.`ACCOMID` AND ROOMID = " . $roomId;
                    $mydb->setQuery($query);
